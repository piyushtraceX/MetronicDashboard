            ...
            <div>
              ...
              <div>
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-medium">Supplier Selection</h3>
                </div>
                ...
                <div className="space-y-4">
                  <div className="relative">
                    ...
                    {supplierSearchTerm && filteredSuppliers.length > 0 && (
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          <div className="h-10 w-10 bg-gray-100 rounded-full flex items-center justify-center">
                            {suppliers.find(s => s.id === selectedSupplierId)?.name.substring(0, 2).toUpperCase()}
                          </div>
                          <div>
                            ...
                            <div className="text-sm text-gray-500">
                              {suppliers.find(s => s.id === selectedSupplierId)?.products}
                            </div>
                          </div>
                        </div>
                        <Button
